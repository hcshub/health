...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "mwPkNyTQkHR9Ksw1QTFzdgKQECXivrxxqfpryfgS";
    private static final String SECRETKEY = "1bCwvMCmtWE6GD-kaE9lzZI_Q6ukElu8JQOvwWtQ";
    private static final String BUCKET = "sflysbd";
    public static final String DOMAIN = "pyeylp7yv.bkt.clouddn.com";
